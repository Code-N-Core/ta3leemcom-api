...
namespace PlatformAPI.EF.Migrations
{
    ...
    [Migration("20240706193631_AddRelationBetweenGroupTableAndTeacherTable")]
    partial class AddRelationBetweenGroupTableAndTeacherTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlatformAPI.Core.Models.Group", b =>
                {
                    ...
                    b.HasOne("PlatformAPI.Core.Models.Teacher", "Teacher")
                        .WithOne("Group")
                        .HasForeignKey("PlatformAPI.Core.Models.Group", "TeacherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
