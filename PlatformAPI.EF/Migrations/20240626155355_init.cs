        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeExist = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LevelYears_Levels_LevelId",
                        column: x => x.LevelId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Explain = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    LevelYearId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Groups", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Groups_LevelYears_LevelYearId",
                        column: x => x.LevelYearId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Chooses_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupsQuizzes", x => new { x.QuizId, x.GroupId });
                    table.ForeignKey(
                        name: "FK_GroupsQuizzes_Groups_GroupId",
                        column: x => x.GroupId,
                        principalTable: "Groups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_GroupsQuizzes_Quizzes_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quizzes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsMonths", x => new { x.StudentCode, x.MonthId });
                    table.ForeignKey(
                        name: "FK_StudentsMonths_Months_MonthId",
                        column: x => x.MonthId,
                        principalTable: "Months",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsQuizzes", x => new { x.StudentCode, x.QuizId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentsAbsences", x => new { x.StudentCode, x.DayId });
                    table.ForeignKey(
                        name: "FK_StudentsAbsences_Days_DayId",
                        column: x => x.DayId,
                        principalTable: "Days",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Groups_LevelYearId",
                table: "Groups",
                column: "LevelYearId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupsQuizzes_GroupId",
                table: "GroupsQuizzes",
                column: "GroupId");

            migrationBuilder.CreateIndex(
                name: "IX_LevelYears_LevelId",
                table: "LevelYears",
                column: "LevelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentsAbsences_DayId",
                table: "StudentsAbsences",
                column: "DayId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentsMonths_MonthId",
